...
public class ProduceWarning {
    ...
    public static class RowsBean {
        ...
        private List<com.example.app.entity.production_warining_item.ItemInfo> message;
        ...
        public List<com.example.app.entity.production_warining_item.ItemInfo> getMessage() {
            return message;
        }

        public void setMessage(List<com.example.app.entity.production_warining_item.ItemInfo> message) {
