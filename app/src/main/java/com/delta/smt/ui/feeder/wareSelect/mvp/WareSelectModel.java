...
//            dataList.add(new WareHouse(11, "Feeder缓冲区"));
        ...
        dataList.add(new WareHouse(1, "A"));
        dataList.add(new WareHouse(2, "B"));
        dataList.add(new WareHouse(3, "C"));
        dataList.add(new WareHouse(4, "D"));
        dataList.add(new WareHouse(5, "E"));
        dataList.add(new WareHouse(6, "F"));
        dataList.add(new WareHouse(7, "G"));
        dataList.add(new WareHouse(8, "H"));
        dataList.add(new WareHouse(9, "I"));
        dataList.add(new WareHouse(10, ""));
        dataList.add(new WareHouse(11, "Feeder"));
