...
public class API {
 ...
 //   public static String BASE_URL = "http://172.22.34.29:8081/";
    public static String BASE_URL = "http://172.22.34.87:8081/";
    //String BASE_URL = "http://172.17.52.43:8081/";
    //更新配置文件update.json url
    public static final String bundleJsonUrl = "http://172.22.34.198:8809/mobile/DG3_Release/update.json";
    // String WebSocketURl ="ws://172.22.34.24:9090";
